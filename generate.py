...
def Create_Robot():
    ...
    pyrosim.Send_Joint(name="Back_Leg_Body", parent="Back_Leg", child="Body", type="revolute", position=[1, 0, 1])
    pyrosim.Send_Cube(name="Body", pos=[0.5, 0, 0.5], size=[1, 1, 1])
    pyrosim.Send_Joint(name="Body_Front_Leg", parent="Body", child="Front_Leg", type="revolute", position=[1, 0, 0])
